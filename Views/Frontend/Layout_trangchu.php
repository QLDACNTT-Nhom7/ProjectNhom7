...
<head>
    ...
    <title>Tùng Anh</title>
    <meta name="description" content="DKT Store">
    <meta property="og:type" content="website">
    <meta property="og:title" content="DKT Store">
    <meta property="og:image" content="Assets/frontend/100/047/633/themes/517833/assets/logo221b.jpg?1481775169361">
    <meta property="og:image:secure_url" content="Assets/frontend/100/047/633/themes/517833/assets/logo221b.jpg?1481775169361">
...
<div class="content">
    <div class="container">
        <h1 style="display:none;">TÙNG ANH</h1>
        <div class="row">
            <div class="col-xs-12 col-md-3">
                <div class="row" style="margin-bottom: 5px;">
                    <div class="col-md-12"><img src="Assets/frontend/images/5.jpeg" class="img-thumbnail" style="width: 286px;height: 155px;"></div>
                </div>
                <div class="row" style="margin-bottom: 5px;">
                    <div class="col-md-12"><img src="Assets/frontend/images/8.jpeg" class="img-thumbnail" style="width: 286px;height: 155px;"></div>
                </div>
                <div class="row">
                    <div class="col-md-12"><img src="Assets/frontend/images/6.jpeg" class="img-thumbnail" style="width: 286px;height: 155px;"></div>
                </div>
            </div>
            <div class="col-md-9">
                <!-- slide -->
        ...
        <!-- adv -->
        <div class="widebanner"> <a href="#"><img src="Assets/frontend/100/047/633/themes/517833/assets/biac.jpg?1481775169361" alt="#" class="img-responsive" style="width: 100%;"></a> </div>
        <!-- end adv -->
...
<footer id="footer">
    ...
    <div class="bottom-footer">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-5"> © Copyright belongs to Nguyễn Thế Tùng</div>
